...
const App = () => {
    ...
    return (
        <div className="App">
            <div className="home">
                    {/* <NewNavBar setBook={(value) => {setBook(value)}} numberOfChapters={numberOfChapters} setTheCurrentChapter={(value) => setCurrentChapter(value)}/> */}
...
//         <div className="App">
//             <div className="home">
//                     <NewNavBar setBookandChapters={(value) => {setBook(value[0], setNumberOfChapters(value[1]))}}/>
//                 <div className="header">
//                     {/* <NewNavBar setBookandChapters={(value) => {setBook(value[0], setNumberOfChapters(value[1], setCurrentChapter(value[2])))}}/> */}
//                     // also need to set the number of chapters here
//                     {/* <NavBar setBookandChapters={(value) => {setBook(value[0], setNumberOfChapters(value[1], setCurrentChapter(value[2])))}}/> */}
